  ...
  return (
    <View style={styles.container}>
      <Animated.View style={[styles.content, { opacity: fadeAnim, transform: [{ scale: scaleAnim }] }]}>
        ...
        <Text style={styles.title}>Thanh toán thành công qua VNPay!</Text>
        <Text style={styles.message}>Cảm ơn bạn đã thanh toán qua VNPay. Đơn hàng của bạn đang được xử lý.</Text>
        <TouchableOpacity
